<script lang="ts">
	...
	const allQuestions: Question[] = [
		...
		{ id: 76, type: 'logic', question: 'Which is NOT a primary color of light? Red, Green, Blue, Yellow', options: ['Red', 'Green', 'Blue', 'Yellow'], correctAnswer: 3, emoji: '🎨', pack: 'science', explanation: 'The primary colors of light are red, green, and blue; yellow is made by mixing red and green light' },
